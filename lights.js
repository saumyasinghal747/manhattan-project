...
const ambientLight = new THREE.AmbientLight(0xf0f0f0, 0.1); // very very dim white light to help with editing
...
function createSpotLight(x,y,z){
    const light = new THREE.PointLight( 0xffeedd, 1, 30 );
    light.position.set( meters(x), meters(y), meters(z) );
}